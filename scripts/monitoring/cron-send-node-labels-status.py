...
def check_label_on_host(labels):
    ...
    master_labels = {'beta.kubernetes.io/arch':'amd64', 'beta.kubernetes.io/instance-type': 'm4.xlarge', 'beta.kubernetes.io/os': 'linux', 'failure-domain.beta.kubernetes.io/region': 'us-east-1', 'failure-domain.beta.kubernetes.io/zone': 'us-east-1a', 'hostname': 'tke-master-9f206', 'kubernetes.io/hostname': 'ip-10-147-203-48.ec2.internal', 'network.openshift.io/not-enforcing-egress-network-policy':'true', 'node-role.kubernetes.io/master': 'true', 'region': 'us-east-1', 'type': 'master'}
    infra_labels = {'beta.kubernetes.io/arch': 'amd64', 'beta.kubernetes.io/instance-type': 'r4.xlarge', 'beta.kubernetes.io/os': 'linux', 'failure-domain.beta.kubernetes.io/region': 'us-east-1', 'failure-domain.beta.kubernetes.io/zone': 'us-east-1a', 'hostname': 'tke-node-infra-6e9f4', 'kubernetes.io/hostname': 'ip-10-147-203-16.ec2.internal', 'logging-infra-fluentd': "true", 'node-role.kubernetes.io/compute': "true", 'region': 'us-east-1', 'type': 'infra'}
    # seems the infra node and compute node have the same labels
    compute_labels = {'beta.kubernetes.io/arch': 'amd64', 'beta.kubernetes.io/instance-type': 'r4.xlarge', 'beta.kubernetes.io/os': 'linux', 'failure-domain.beta.kubernetes.io/region': 'us-east-1', 'failure-domain.beta.kubernetes.io/zone': 'us-east-1a', 'hostname': 'tke-node-infra-6e9f4', 'kubernetes.io/hostname': 'ip-10-147-203-16.ec2.internal', 'logging-infra-fluentd': "true", 'node-role.kubernetes.io/compute': "true", 'region': 'us-east-1', 'type': 'infra', 'ops_node': 'new'}
